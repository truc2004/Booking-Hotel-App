...
//       // 2. Gọi backend để tạo / lấy account theo email
//       await accountApi.createOrGetAccount(
//         email.trim(),
//         name.trim()
//       );

//       // 3. ĐĂNG XUẤT ra, để guard không redirect sang home nữa
//       await signOut();

//       // 4. Quay về màn Sign In
