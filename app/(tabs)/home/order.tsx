...
export default function BookingScreen() {
    ...
    const handleBooking = () => {
        ...
        // ====== BUNDLE BOOKING DATA ĐỂ GỬI SANG PAYMENT ======
        const bookingData = {
            account_id: null, // TODO: lấy từ user hiện tại nếu có
            room_id,
            user_booking_info: {
                full_name: form.name,
                phone: form.phone,
            ...
            // booking_date: không gửi -> để default schema (Date.now)
            extra_fee: extraFee,
            room_price: room?.price_per_night ?? 0,
            total_price: totalAmount,
            note: note || "",
            status: "PENDING", // lúc bấm "Xác nhận & Thanh toán"
            // created_at, updated_at: để timestamps handle
        };
